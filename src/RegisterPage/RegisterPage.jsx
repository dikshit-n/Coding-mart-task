...
class RegisterPage extends React.Component {
  ...
  handleSubmit(event) {
    ...
    const { user } = this.state;
    if (user.username && user.phone && user.mailid && user.password) {
    ...
    return (
      <div className="col-md-6 col-md-offset-3">
        ...
        <form name="form" onSubmit={this.handleSubmit}>
          ...
          <div
            className={
              "form-group" + (submitted && !user.mailid ? " has-error" : "")
            }
          >
            ...
            <input
              ...
              onChange={this.handleChange}
            />
            {submitted && !user.mailid && (
              <div className="help-block">Mail ID is required</div>
            )}
          </div>
          <div
            className={
